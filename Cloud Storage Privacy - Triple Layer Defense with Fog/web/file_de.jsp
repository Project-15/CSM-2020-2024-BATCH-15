        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="file_de.jsp">File View</a>
              </li>
              <li class="nav-item">
          ...
          <table class="table table-striped border-1 bg-white rounded table-bordered">
            <thead>
              <tr>
                ...
                <th scope="col">MAC 1</th>
                <th scope="col">MAC 2</th>
                <th scope="col">MAC 3</th>
              ...
              <%
                        ...
                        <tr>
                          <td style="color: midnightblue; font-size: 16px"><%=sl++%></td>
                            ...
                            <td style="color: midnightblue; font-size: 16px"><%= "************" + rs.getString("mac1").substring(rs.getString("mac1").length() - 5) %></td>
                            <td style="color: midnightblue; font-size: 16px"><%=  "************" + rs.getString("mac2").substring(rs.getString("mac2").length() - 5) %></td>
