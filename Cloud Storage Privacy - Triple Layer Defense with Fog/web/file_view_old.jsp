<%--
    Document   : update
    Created on : 13 Nov, 2016, 9:39:17 AM
    Author     : kalai
--%>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="content_resize"> <img src="images/up.jpg" width="958" height="245" alt="" class="hbg_img" />
                    ...
                    <br>
                        <center><font style="font-size: 20px; color: crimson ">File Name :</font>&nbsp;&nbsp;<font style="font-size: 20px; color: #4CAF50"><%=fname%></font></center>
                        <center>
                            <br><form action="update1.jsp"  method="get">
                                    <textarea name="files" cols="60" rows="5" readonly=""><%=CeasarCipher%></textarea><br>
