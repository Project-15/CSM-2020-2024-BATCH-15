        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="user_de.jsp">Authentication</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="file_de2.jsp">File Details</a>
              </li>
              <li class="nav-item">
            ...
            <tbody class="align-middle lead">
              <%
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from file_view where status='Yes'");
                                while (rs.next()) {
