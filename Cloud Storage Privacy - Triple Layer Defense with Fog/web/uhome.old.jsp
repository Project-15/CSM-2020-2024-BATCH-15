                ...
                <div class="content_resize"> <img src="images/up.jpg" width="958" height="245" alt="" class="hbg_img" />
                    <div class="mainbar">
                        <div class="article">
                            ...
                            %>
                            <center><font style="font-family: fantasy; font-size: x-large; color: crimson; font-style: inherit">WELCOME&nbsp; :</font>&nbsp;&nbsp;&nbsp;<font style="font-family: fantasy; font-size: x-large; color: #4CAF50; font-style: inherit"><%=user%></font><br>
